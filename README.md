...
<head>
    ...
    <style>
        * {
        ...
        /* Updated copy button style for better visibility */
    ...
    <div class="container">
        ...
        <div class="converter-section">
            ...
            <div class="results-grid">
                ...
                <div class="result-card" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%);">
                    <div class="result-header">
                        <h3 id="hex-title">سادس عشر (Hexadecimal)</h3>
                        <button class="copy-btn" onclick="copyResult('hex')" id="copy-hex">📋 نسخ</button>
                    </div>
                    <div class="result-value" id="hex-result">0</div>
                </div>
            </div>
        </div>
    </div>
